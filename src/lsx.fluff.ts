...
export const GetFluffFiles = {
  encode(_: GetFluffFiles, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
...
export const GetFluffState = {
  encode(_: GetFluffState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
...
export const SetFluffState = {
  encode(_: SetFluffState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
